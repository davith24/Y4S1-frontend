...
export const AutoComplete = ({ options, placeholder, emptyMessage, value, onValueChange, disabled, isLoading = false }: AutoCompleteProps) => {
  ...
  return (
    <CommandPrimitive onKeyDown={handleKeyDown}>
      ...
      <div className="relative mt-1">
        <div
          className={cn("animate-in fade-in-0 zoom-in-95 absolute top-0 z-10 w-full rounded-xl bg-white outline-none", isOpen ? "block" : "hidden")}
        >
